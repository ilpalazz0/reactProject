...
function Header({ onCartClick }) {
    ...
    return (
        <header>
            <div className="logo">
                <img src={logo} alt="HS texnologiya"/>
            </div>
            <nav className="navbar">
                <ul>
                    <Link to="/" className="button1">Home</Link>
                    <Link to="/service" className="button1">Service</Link>
                    <Link to="/about" className="button1">About</Link>
                    <Link to="/contacts" className="button1">Contacts</Link>
                </ul>
            </nav>
            
            <div className="header-info">
                <Link to="/location" className="info-item" id="map-link">
